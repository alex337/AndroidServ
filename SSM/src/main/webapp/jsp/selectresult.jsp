...
<div class="panel admin-panel margin-top">
    <div class="body-content">
        <form method="post" class="form-x" action="${pageContext.request.contextPath}/stuwork/selectresult" method="get">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <select id="lunch" name="stuClass" class="input w50" data-live-search="true"  >
