...
<table>
    ...
    <c:forEach var="document" items="${doclist}">
        <tr class="gradeX">
            ...
            <td><a style="color: #5eb95e" href="${pageContext.request.contextPath}/document/download?filename=${document.filename}">
                下载
            </a></td>
        </tr>
    </c:forEach>
...
<br /> <br /> <label>第${page.currentPage}/${page.totalPage}页
    共${page.totalRows}条</label> <a href="${pageContext.request.contextPath}/document/selectdoc?currentPage=0">首页</a> <a
        href="${pageContext.request.contextPath}/document/selectdoc?currentPage=${page.currentPage-1}"
        onclick="return checkFirst()">上一页</a> <a
        href="${pageContext.request.contextPath}/document/selectdoc?currentPage=${page.currentPage+1}"
        onclick="return checkNext()">下一页</a> <a
        href="${pageContext.request.contextPath}/document/selectdoc?currentPage=${page.totalPage}">尾页</a> 跳转到:<input
